...
export const farmers: Farmer[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    lastSmsActivity: '2026-03-08T12:15:00Z',
    status: 'pending_approval'
  },
  {
    id: 'FARM007',
...
export const smsMessages: SmsMessage[] = [
  ...
  },
  {
    ...
    phone: '+639226789012',
    message: 'Malakas po ang ulan at naiipon ang tubig sa taniman ng okra. Ano po ang dapat unahin bago tumaas ang baha?',
    timestamp: '2026-03-08T12:15:00Z',
    parsedIntent: 'WEATHER_HELP',
    urgency: 'high',
    status: 'approved',
    caseId: 'CASE-DEMO-WEATHER-001',
    caseStatus: 'monitoring',
    assignedTo: 'AEW Jose Rizal',
    assignedToUserId: 'aew@lingkodani.gov.ph',
    assignedAt: '2026-03-08T12:18:00Z',
    respondedAt: '2026-03-08T12:23:00Z',
    followUpDueAt: '2026-03-09T08:00:00Z',
    caseOutcomeStatus: 'monitoring',
    aiAdvice: 'Unahin ang ligtas na paglinis ng daluyan ng tubig at ilipat sa mataas at tuyong lugar ang binhi, abono, at portable na kagamitan. Huwag tumawid sa rumaragasang tubig at mag-update sa barangay kapag patuloy ang pagtaas ng baha.',
    aiConfidence: 0.91,
    safetyFlag: 'High',
    tone: 'Kritikal',
    analysisSource: 'ai',
  ...
  },
  {
    ...
    phone: '+639193456789',
    message: 'Magkano po ang bentahan ng tubo kada kilo ngayong linggo? Balak naming bumiyahe sa bagsakan bukas.',
    timestamp: '2026-03-08T11:30:00Z',
    parsedIntent: 'PRICE_CHECK',
    urgency: 'low',
    status: 'replied',
    caseId: 'CASE-DEMO-PRICE-001',
    caseStatus: 'closed',
    assignedTo: 'Sec. Maria Clara',
    assignedToUserId: 'secretary@lingkodani.gov.ph',
    assignedAt: '2026-03-08T11:34:00Z',
    respondedAt: '2026-03-08T11:40:00Z',
    closedAt: '2026-03-08T11:50:00Z',
    caseOutcomeStatus: 'resolved',
    caseOutcomeSummary: 'Naibigay ang pinakahuling verified na presyo at nakumpirma ang bukas na buying station.',
    caseOutcomeUpdatedAt: '2026-03-08T11:50:00Z',
    caseOutcomeUpdatedBy: 'Sec. Maria Clara',
    resolutionConfirmationStatus: 'confirmed_by_farmer',
    resolutionConfirmationRequestedAt: '2026-03-08T11:42:00Z',
    resolutionConfirmedAt: '2026-03-08T11:50:00Z',
    aiAdvice: 'Ang pinakahuling presyong na-verify ng barangay ay nasa local Price Watch. Kumpirmahin muna ang presyo at oras ng bukas na buying station bago bumiyahe dahil maaari itong magbago.',
    aiConfidence: 0.96,
    safetyFlag: 'Low',
    tone: 'Neutral',
    analysisSource: 'ai',
...
export const farmerLogbookEntries: LogbookEntry[] = [
    ...
    },
    {
        id: 'LOG003',
        farmerId: 'FARM006',
        timestamp: '2026-03-08T12:23:00Z',
        type: 'Payo',
        title: 'Nagbigay ng paunang gabay sa baha',
        description: 'Naipadala ang ligtas na drainage at equipment-preparation guidance kay Gabriela Silang.',
    },
    {
        id: 'LOG004',
        farmerId: 'FARM003',
        timestamp: '2026-03-08T11:50:00Z',
        type: 'SMS',
        title: 'Nakumpirma ang price inquiry',
        description: 'Naibigay ang verified market reference at nakumpirma ng magsasaka ang tugon.',
    }
];
...
export const auditLogs: AuditLog[] = [
    ...
    { id: 'AUD007', timestamp: '2026-03-08T12:23:00Z', user: 'AEW Jose Rizal', action: 'MONITOR_WEATHER_CASE', details: 'Inaprubahan ang safety guidance at minarkahang for monitoring ang SMS009 mula kay Gabriela Silang.', category: 'operations', severity: 'warning' },
    { id: 'AUD008', timestamp: '2026-03-08T11:50:00Z', user: 'Sec. Maria Clara', action: 'CLOSE_PRICE_CASE', details: 'Isinara ang SMS010 matapos maibigay at makumpirma ang verified market reference.', category: 'operations', severity: 'info' },
];
...
export const outboundMessages: OutboundMessage[] = [
  ...
  },
  {
    id: 'OUT005',
    smsMessageId: 'SMS009',
    recipientPhone: '+639226789012',
    body: 'Unahin ang ligtas na drainage at ilipat sa mataas na lugar ang farm inputs. Huwag tumawid sa rumaragasang tubig at mag-update kung tataas pa ang baha.',
    status: 'delivered',
    provider: 'demo',
    providerMessageId: 'demo-msg-005',
    createdAt: '2026-03-08T12:21:00Z',
    sentAt: '2026-03-08T12:22:00Z',
    lastStatusAt: '2026-03-08T12:23:00Z',
    deliveryReceivedAt: '2026-03-08T12:23:00Z',
    attempts: 1,
  },
  {
    id: 'OUT006',
    smsMessageId: 'SMS010',
    recipientPhone: '+639193456789',
    body: 'Nasa Price Watch ang pinakahuling verified na presyo ng tubo. Kumpirmahin muna ang presyo at oras ng buying station bago bumiyahe.',
    status: 'delivered',
    provider: 'demo',
    providerMessageId: 'demo-msg-006',
    createdAt: '2026-03-08T11:38:00Z',
    sentAt: '2026-03-08T11:39:00Z',
    lastStatusAt: '2026-03-08T11:40:00Z',
    deliveryReceivedAt: '2026-03-08T11:40:00Z',
    attempts: 1,
  },
];
