...
export const smsMessages: SmsMessage[] = [
  ...
  },
  {
    ...
    urgency: 'high',
    status: 'rejected',
    respondedAt: '2026-03-08T07:22:00Z',
...
export const marketPrices: MarketPriceEntry[] = [
  { id: 'PRICE001', crop: 'Palay', price: 24, unit: 'kilo', source: 'Batakil Bagsakan', trend: 'up', updatedAt: '2026-03-15T07:10:00Z' },
  { id: 'PRICE002', crop: 'Mais', price: 19, unit: 'kilo', source: 'Barangay Trading Post', trend: 'steady', updatedAt: '2026-03-15T06:45:00Z' },
  { id: 'PRICE003', crop: 'Kamatis', price: 42, unit: 'kilo', source: 'Public Market', trend: 'down', updatedAt: '2026-03-14T22:00:00Z' },
  { id: 'PRICE004', crop: 'Sili', price: 165, unit: 'kilo', source: 'Highway Farm Gate', trend: 'up', updatedAt: '2026-03-13T02:15:00Z' },
  { id: 'PRICE005', crop: 'Okra', price: 38, unit: 'kilo', source: 'Batakil Bagsakan', trend: 'steady', updatedAt: '2026-03-10T09:20:00Z' },
];
...
export const alertHistory: AlertHistoryEntry[] = [
  ...
  },
  {
    ...
    type: 'pest',
    severity: 'Warning',
    message: 'Babala: May sunod-sunod na ulat ng rice bugs at daga sa palayan ng Zone 1 at Zone 3.',
    recommendation: 'Magsagawa ng inspeksyon sa loob ng 24 oras at makipag-ugnayan sa barangay para sa pesticide o trap support.',
    source: 'ai',
  ...
  },
  {
    ...
    type: 'heat',
    severity: 'Warning',
    message: 'Babala: Posibleng tumaas ang init sa susunod na dalawang araw na maaaring makaapekto sa gulay at bagong tanim.',
    recommendation: 'Diligan sa maagang umaga o hapon at i-monitor ang stress ng halaman sa maghapon.',
    source: 'manual',
...
export const assistanceRecords: FarmerAssistanceRecord[] = [
  {
    id: 'AST001',
    farmerId: 'FARM009',
    type: 'Pesticide',
  ...
  },
  {
    ...
    title: 'Tomato pest management guidance',
    details: 'Kailangan ng onsite check at leaf sample review para sa tomato leafminer concern.',
    status: 'planned',
    providedBy: 'AEW Jose Rizal',
  ...
  },
  {
    ...
    farmerId: 'FARM004',
    type: 'Kagamitan',
    title: 'Sprayer loan assistance',
    details: 'Nakapila para sa barangay sprayer loan habang naghihintay ng available unit.',
    quantity: '1 yunit',
    status: 'in_progress',
    providedBy: 'Sec. Maria Clara',
...
export const fieldVisitTasks: FieldVisitTask[] = [
  {
    id: 'VISIT001',
    farmerId: 'FARM009',
  ...
  },
  {
    id: 'VISIT003',
    farmerId: 'FARM004',
    title: 'Equipment handoff coordination',
    purpose: 'I-confirm kung kailan puwedeng kunin ang sprayer at kung kailangan pa ng manual assistance.',
    scheduledFor: '2026-03-17T00:00:00Z',
    assignedTo: 'Sec. Maria Clara',
    priority: 'medium',
    status: 'scheduled',
...
export const knowledgeArticles: KnowledgeArticle[] = [
    {
        ...
        summary: 'Paunang gabay sa pagkilala ng tomato leafminer, ligtas na unang aksyon, at kailan dapat magpa-field visit.',
        content: 'Para sa mga kamatis sa Batakil na may silver trails, butas, o naninilaw na dahon, huwag agad magbigay ng malakas na kemikal nang walang validation. Unahing alisin ang matinding apektadong dahon, obserbahan kung gaano kalawak ang pinsala, at ihiwalay ang pinakamatinding bahagi ng taniman kung maaari. Kapag mabilis ang pagdami o may bagong pinsala sa maraming puno, i-escalate agad sa AEW para sa onsite assessment at mas ligtas na rekomendasyon.',
        keywords: ['kamatis', 'peste', 'leafminer', 'organiko', 'batakil', 'yellowing'],
        lastUpdated: '2026-03-20',
        author: 'AEW Jose Rizal',
        type: 'article',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-20T08:00:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Batakil demo knowledge pack',
        sourceType: 'manual',
        version: 2,
    },
    {
        ...
        content: 'Pagkatapos ng anihan, siguraduhing malinis ang sako at tuyo ang butil bago itabi. Targetin ang maayos na pagpapatuyo bago iimbak upang maiwasan ang amag at post-harvest pests. Sa barangay context, mahalaga ring maitala kung may kakulangan sa drying space o hauling support para ma-follow up ng barangay team.',
        keywords: ['palay', 'ani', 'imbakan', 'pagpapatuyo', 'post-harvest'],
        lastUpdated: '2026-03-18',
        author: 'Sec. Maria Clara',
        type: 'article',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-18T07:30:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Batakil operations notes',
        sourceType: 'manual',
        version: 2,
    },
    {
        ...
        content: 'Kung naninilaw ang palay at pinaghihinalaang kulang sa nitrogen, huwag agad doblihin ang urea nang walang validation. Suriin muna kung pare-pareho ang paninilaw, kung bagong ulan lang, at kung may waterlogging. Ang paunang payo ay dapat nakatuon sa ligtas na assessment at referral sa AEW kapag malawak ang apektado o may halong iba pang sintomas.',
        keywords: ['urea', 'pataba', 'aplikasyon', 'sustansya', 'nitrogen', 'palay'],
        lastUpdated: '2026-03-17',
        author: 'AEW Jose Rizal',
        type: 'article',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-17T09:10:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Batakil nutrient advisory notes',
        sourceType: 'manual',
        version: 2,
    },
    {
        id: 'KB034',
        title: 'Batakil Rice Bug Watch at Unang Tugon',
        summary: 'Barangay-focused na gabay kapag may ulat ng rice bugs sa palayan ng Zone 1 hanggang Zone 3.',
        content: 'Kapag may rice bug report sa Batakil, unahin ang pagtukoy kung iisang bahagi lang o maraming pilapil ang apektado. Huwag magbanggit agad ng eksaktong dosage sa SMS kung wala pang validation. Ang ligtas na paunang tugon ay: obserbahan ang lawak, ihiwalay ang pinakaapektadong bahagi kung kaya, at i-alert agad ang barangay kung mabilis ang pagdami o malapit na ang heading stage ng palay.',
        keywords: ['rice bug', 'palay', 'batakil', 'zone 1', 'zone 3', 'outbreak'],
        lastUpdated: '2026-03-21',
        author: 'AEW Jose Rizal',
        type: 'tip',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-21T06:45:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Batakil pest watch',
        sourceType: 'manual',
        version: 1,
    },
    {
        id: 'KB035',
        title: 'Paunang Gabay sa Baha para sa Mababang Palayan sa Batakil',
        summary: 'Checklist ng mga unang hakbang kapag may bantang baha o flood damage sa mababang bahagi ng barangay.',
        content: 'Para sa mga palayang nasa mababang bahagi ng Batakil, unahing i-secure ang punla, abono, at portable equipment bago tumaas ang tubig. Kung nasira na ang tanim, hikayatin ang magsasaka na magpadala ng maikling ulat kung gaano kalawak ang apektado at kung anong stage na ng tanim. Ang system response ay dapat nag-a-acknowledge muna ng pinsala, humihingi ng critical details, at mabilis na nag-e-escalate sa barangay team.',
        keywords: ['baha', 'palay', 'batakil', 'mababang lugar', 'flood damage'],
        lastUpdated: '2026-03-19',
        author: 'Brgy. Admin',
        type: 'article',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-19T05:20:00Z',
        reviewedBy: 'Brgy. Captain Cruz',
        sourceLabel: 'Batakil flood readiness memo',
        sourceType: 'manual',
        version: 1,
    },
    {
        id: 'KB036',
        title: 'Init, Tagtuyot, at Patubig para sa Gulayan sa Pangasinan',
        summary: 'Lokal na paalala para sa gulayan kapag mataas ang init at kapos ang tubig.',
        content: 'Sa matinding init, mas mahalaga ang tamang oras ng pagdidilig kaysa dami lang ng tubig. Para sa gulay sa Pangasinan setting, mas ligtas ang maagang umaga o hapon na patubig at pag-check kung may sunscald o heat stress. Kung may ulat ng pagkalanta ngunit hindi malinaw kung dahil sa peste o init, unahin ang clarification kaysa agarang diagnosis.',
        keywords: ['init', 'tagtuyot', 'patubig', 'gulay', 'pangasinan', 'heat stress'],
        lastUpdated: '2026-03-16',
        author: 'Sec. Maria Clara',
        type: 'tip',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-16T04:15:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Pangasinan vegetable heat advisory',
        sourceType: 'manual',
        version: 1,
    },
    {
        id: 'KB037',
        title: 'Ligtas na Wording Kapag Nanghihingi ng Pesticide ang Magsasaka',
        summary: 'Guardrail article para sa SMS at dashboard staff replies kapag diretsong humihingi ng pesticide o lason.',
        content: 'Kapag ang magsasaka ay humihingi agad ng pesticide, huwag agad magpadala ng direct product or dosage recommendation sa SMS kung hindi pa validated ang exact issue. Mas ligtas ang wording na: natanggap ang ulat, huwag munang basta gumamit ng kahit anong kemikal, at ipa-check muna sa barangay agricultural personnel ang sintomas at lawak ng pinsala. Ang artikulong ito ay para sa response safety at human review escalation.',
        keywords: ['pesticide', 'lason', 'guardrail', 'sms safety', 'human review'],
        lastUpdated: '2026-03-22',
        author: 'Developer',
        type: 'myth-buster',
        reviewStatus: 'approved',
        reviewedAt: '2026-03-22T02:00:00Z',
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Response safety guardrail',
        sourceType: 'manual',
        version: 1,
    },
    {
        ...
        reviewedBy: 'Brgy. Admin',
        sourceLabel: 'Demo audio library',
...
export const registeredUsers = [
    ...
    {
      id: 'captain@lingkodani.gov.ph',
      email: 'captain@lingkodani.gov.ph',
      name: 'Bgy. Captain Cruz',
      role: 'barangay' as const,
      ...
      lastLoginAt: '2026-03-07T09:10:00Z',
    },
    {
      id: 'secretary@lingkodani.gov.ph',
      email: 'secretary@lingkodani.gov.ph',
      name: 'Sec. Maria Clara',
      role: 'barangay' as const,
    ...
    },
    {
      ...
      lastLoginAt: '2026-03-07T10:00:00Z',
    },
    {
      id: 'dev@lingkodani.gov.ph',
...
export const outboundMessages: OutboundMessage[] = [
  {
    ...
    body: 'Para sa post-harvest, tiyaking maayos ang pagpapatuyo ng mga butil sa 14% na moisture content bago itago.',
    status: 'delivered',
    provider: 'demo',
    providerMessageId: 'demo-msg-001',
    createdAt: '2026-03-08T09:16:00Z',
    sentAt: '2026-03-08T09:17:00Z',
    lastStatusAt: '2026-03-08T09:18:00Z',
    deliveryReceivedAt: '2026-03-08T09:18:00Z',
    attempts: 1,
  },
  {
    id: 'OUT002',
    smsMessageId: 'SMS003',
    recipientPhone: '+639193456789',
    body: 'Kailangan pa ng field validation para sa sugarcane borer concern. Magpapadala ang barangay ng follow-up schedule.',
    status: 'delivered',
    provider: 'demo',
    providerMessageId: 'demo-msg-002',
    createdAt: '2026-03-08T07:19:00Z',
    sentAt: '2026-03-08T07:20:00Z',
    lastStatusAt: '2026-03-08T07:22:00Z',
    deliveryReceivedAt: '2026-03-08T07:22:00Z',
    attempts: 1,
  },
  {
    id: 'OUT003',
    smsMessageId: 'SMS004',
    recipientPhone: '+639204567890',
    body: 'May available na sprayer sa barangay hall. Magre-retry kami ng mensahe kapag stable na ulit ang gateway.',
    status: 'failed',
    provider: 'demo',
    providerMessageId: 'demo-msg-003',
    errorMessage: 'No signal on gateway device during send attempt.',
    createdAt: '2026-03-08T05:42:00Z',
    sentAt: '2026-03-08T05:43:00Z',
    lastStatusAt: '2026-03-08T05:44:00Z',
    attempts: 2,
  },
  {
    id: 'OUT004',
    smsMessageId: 'SMS006',
    recipientPhone: '+639171234567',
    body: 'Naitala ang bagyo damage report mo. Mangyaring maghanda ng larawan at listahan ng nasirang pananim para sa validation.',
    status: 'sent',
    provider: 'demo',
    providerMessageId: 'demo-msg-004',
    createdAt: '2026-03-08T08:06:00Z',
    sentAt: '2026-03-08T08:07:00Z',
    lastStatusAt: '2026-03-08T08:07:00Z',
    attempts: 1,
  },
];

export const smsTrainingExamples: SmsTrainingExample[] = [
  {
    id: 'TRAIN001',
    smsMessageId: 'SMS002',
    farmerId: 'FARM001',
    ...
    phone: '+639171234567',
    message: 'HARVEST PALAY 120kg. Malapit na ang anihan ng palay ko. May mga tip ba para pagkatapos ng ani?',
    inboundTimestamp: '2026-03-08T09:00:00Z',
    analysisSource: 'ai',
    originalAnalysis: {
      parsedIntent: 'HARVEST',
      urgency: 'medium',
    ...
    finalReview: {
      ...
      status: 'approved',
      finalAdvice: 'Para sa post-harvest, tiyaking maayos ang pagpapatuyo ng mga butil sa 14% na moisture content bago itago. Gumamit ng malinis na sako at mga pasilidad ng imbakan upang maiwasan ang mga peste.',
      finalAnalysis: {
        parsedIntent: 'HARVEST',
        urgency: 'medium',
        safetyFlag: 'Low',
      ...
      reviewedBy: 'Brgy. Admin',
      reviewedAt: '2026-03-08T09:18:00Z',
  ...
  },
  {
    ...
    phone: '+639193456789',
    message: 'PEST SUGARCANE BORER. Kinakain ng peste ang mga tubo ko. Mukha silang mga borer.',
    inboundTimestamp: '2026-03-08T07:00:00Z',
    analysisSource: 'ai',
    originalAnalysis: {
      parsedIntent: 'PEST_DISEASE',
      urgency: 'high',
    ...
    finalReview: {
      action: 'rejected',
      status: 'rejected',
      finalAdvice: 'Kailangan pa ng ocular visit bago magbigay ng rekomendadong treatment para sa sugarcane borer concern na ito.',
      finalAnalysis: {
        parsedIntent: 'PEST_DISEASE',
        urgency: 'high',
        safetyFlag: 'Medium',
      ...
      reviewedBy: 'AEW Jose Rizal',
      reviewedAt: '2026-03-08T07:22:00Z',
  ...
  },
  {
    ...
    farmerName: 'Felipe M. Macedonio',
    phone: '+639159876543',
    message: 'May kailangan po akong follow-up tungkol sa pesticide schedule para sa palayan ko.',
    inboundTimestamp: '2026-03-07T16:10:00Z',
    ...
    originalAnalysis: {
      ...
      safetyFlag: 'Low',
      tone: 'Neutral',
      aiAdvice: 'Maaari naming i-check ang inventory at padalhan ka ng update tungkol sa pesticide release schedule.',
      aiConfidence: 0.68,
    },
    finalReview: {
      action: 'manual_reply',
      status: 'replied',
      finalAdvice: 'May nakareserba nang 2 bote para sa iyo. Mangyaring bumisita sa barangay hall bukas ng umaga para sa release at validation.',
      finalAnalysis: {
        parsedIntent: 'REQUEST',
        urgency: 'medium',
        safetyFlag: 'Low',
      ...
      reviewedBy: 'Sec. Maria Clara',
      reviewedAt: '2026-03-07T16:25:00Z',
      wasAdviceEdited: true,
    },
  },
];
