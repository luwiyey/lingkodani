...
function readFriendlyResetError(error: unknown) {
  ...
  if (normalized.includes('user-not-found')) {
    return 'Mukhang wala pang existing live account para sa email na ito. Kailangan muna itong ihanda ng developer o barangay admin bago magamit ang reset password.';
  }
              ...
              <div className="rounded-[calc(var(--radius)+4px)] border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    <p>
                      Para lang ito sa <span className="font-semibold">existing live accounts</span> na naihanda na ng developer o barangay admin.
                    </p>
                    <p>
