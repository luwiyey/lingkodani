...
function LoginPageContent() {
  ...
  const [accessErrorMessage, setAccessErrorMessage] = useState(
    "Ang email address na iyong inilagay ay hindi nakarehistro sa aming sistema. Mangyaring makipag-ugnayan sa developer o barangay administrator upang ma-access ang Lingkod-Ani."
  );
  ...
  const handleLogin = async (event: React.FormEvent) => {
    ...
    setAccessErrorMessage("Ang email address na iyong inilagay ay hindi nakarehistro sa aming sistema. Mangyaring makipag-ugnayan sa developer o barangay administrator upang ma-access ang Lingkod-Ani.");
    setShowNotRegisteredDialog(true);
    setLoading(false);
  };
          ...
          <CardContent className="px-6 pb-6 pt-2 sm:px-7 sm:pb-7">
            ...
            {requestedAccess ? (
              <div className="mb-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-left text-sm text-emerald-900">
                Naisumite na ang access request mo. Hintayin ang developer o barangay admin na maihanda ang account bago subukang mag-login muli.
              </div>
            ) : null}
