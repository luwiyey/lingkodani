...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-[calc(var(--radius)+2px)] border border-border/90 bg-card">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "h-12 border-b border-border/80 transition-colors duration-150 ease-out hover:bg-muted/60 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
