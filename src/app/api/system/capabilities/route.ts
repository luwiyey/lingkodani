  ...
  const payload: RuntimeCapabilities = {
    ...
    reasons: {
      ...
      liveSmsTestMode: liveSmsTestModeEnabled
        ? "Naka-enable ngayon ang developer-only live SMS preview route para sa kontroladong smoke testing. I-disable muli ito pagkatapos ng tests."
        : "Naka-lock ngayon ang live SMS preview route. I-enable lang ito sa kontroladong developer smoke tests.",
