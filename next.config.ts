...
const nextConfig: NextConfig = {
  env: {
    NEXT_PUBLIC_APP_MODE:
      process.env.NEXT_PUBLIC_APP_MODE ?? process.env.APP_MODE ?? "demo",
    NEXT_PUBLIC_ENABLE_REAL_SMS:
      process.env.NEXT_PUBLIC_ENABLE_REAL_SMS ?? process.env.ENABLE_REAL_SMS ?? "false",
    ...
    NEXT_PUBLIC_LIVE_SMS_PROVIDER:
      process.env.NEXT_PUBLIC_LIVE_SMS_PROVIDER ?? process.env.LIVE_SMS_PROVIDER ?? "generic",
  },
  turbopack: {
    root: process.cwd(),
  },
